...
<html>
<head>
<title>Intereactive Mathematics Edit Notices
...
if($_SESSION["userid"]==true)
{
	   ...
	   if(isset($_GET['id']))
       {
	     ...
	     if(isset($_POST['update']))
         {
		   ...
		   $updated=mysqli_query($con, "UPDATE noticetbl SET notice='$title',description='$description',postdate='$post_date' WHERE noteid='$id'") or die();
       if($updated)
      {
...
<?php 
  ...
  $getselect=mysqli_query($con, "SELECT * from noticetbl  WHERE noteid='$id'");
 
  while($notice = mysqli_fetch_array($getselect))
  {  
     $note=$notice['notice'];
