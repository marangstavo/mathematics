...
<html>
<head>
<title>Intereactive Mathematics Category
...
if($_SESSION["userid"]==true)
{
	   ...
	   if(isset($_GET['id']))
       {
	     ...
	     if(isset($_POST['update']))
         {
		   ...
		   $updated=mysqli_query($con, "UPDATE categorytbl SET catname='$name',deptname='$deptname' WHERE cid='$id'") or die();
       if($updated)
      {
...
<?php 
  ...
  $getselect=mysqli_query($con , "SELECT * from categorytbl  WHERE cid='$id'");
 
  while($category = mysqli_fetch_array($getselect))
  {  
