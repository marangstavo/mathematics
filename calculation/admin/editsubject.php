...
<html>
<head>
<title>Intereactive Mathematics Edit subject
...
if($_SESSION["userid"]==true)
{
	   ...
	   if(isset($_GET['id']))
       {
	     ...
	     if(isset($_POST['update']))
         {
		   ...
		   $name=$_POST['catnm'];	
		   $updated=mysqli_query($con , "UPDATE subjecttbl SET subname='$subname',deptname='$deptname', catname='$name' WHERE sid='$id'") or die();
       if($updated)
      {
...
<?php 
  ...
  $getselect=mysqli_query($con, "SELECT * from subjecttbl  WHERE sid='$id'");
 
  while($subject = mysqli_fetch_array($getselect))
  {  
     $sname=$subject['subname'];
     $dname=$subject['deptname'];
	 $cname=$subject['catname'];
?>
   <?php include("header.php");?>
	<ol class="breadcrumb">
	            
                <center><li class="breadcrumb-item"><h4><a href="">Edit Subject</a></h4></li></center>
            </ol>
<!--grid-->
 	...
 	<!---->
        ...
        <form action="" method="post">
		    <div class="col-md-6 form-group1">
              ...
              <input type="text" placeholder="Subject" name="subnm" value="<?php echo $sname; ?>" required="">
            </div>
            ...
            <select name="deptnm" id="">
              ...
              <?php $sql = "SELECT DISTINCT(catname) AS catname FROM categorytbl where cstatus='1'";
                $result = mysqli_query($con, $sql); ?>
