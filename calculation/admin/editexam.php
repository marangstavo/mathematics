...
<html>
<head>
<title>Intereactive Mathematics Edit Exam
...
if($_SESSION["userid"]==true)
{
	   ...
	   if(isset($_GET['id']))
       {
	     ...
	     if(isset($_POST['update']))
         {
		   ...
		   $updated=mysqli_query($con, "UPDATE examtbl SET examname='$examnm',duration='$duration',percentage='$percent', reexam='$reexam',deadline='$deadline',subname='$subnm',deptname='$deptnm',catname='$catnm',instruction='$terms' WHERE examid='$id'") or die();
...
<?php 
  ...
  $getselect=mysqli_query($con, "SELECT * from examtbl WHERE examid='$id'");
 
  while($exam = mysqli_fetch_array($getselect))
  {  
