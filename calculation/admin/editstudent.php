...
<html>
<head>
<title>Intereactive Mathematics Edit student 
...
if($_SESSION["userid"]==true)
{
	   ...
	   if(isset($_GET['id']))
       {
		...
		else
		{
		   ...
		   $updated=mysqli_query($con, "UPDATE studenttbl SET 
                fname='$fname',lname='$lname',gender='$gender',blood='$blood',email='$email',phone='$phone',mobile='$mobile',password='$password',cpassword='$cpassword',dob='$dob',address='$address',deptname='$deptname',catname='$catname',file='$userprofile' WHERE studid='$id'") or die();
       if($updated)
      {
...
<?php 
  ...
  $getselect=mysqli_query($con, "SELECT * from studenttbl  WHERE studid='$id'");
...
?>
   <?php include("header.php");?>
	<ol class="breadcrumb">
                <center><li class="breadcrumb-item"><h4><a href="">Edit Student</a></h4></li></center>
            </ol>
<!--grid-->
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <select name="catnm" id="">
			 ...
			 <div class="col-md-12 form-group1 group-mail">
			  ...
			  <p><img src="../student/uploaded/<?php echo $ufile; ?>" height="50" width="50" /></p>
